...
const Home = () => {
    return (
        <div 
        name='home' 
        className='relative py-14 md:h-screen w-full bg-gradient-to-t from-black via-black to-gray-800'
        >
            <div className='py-4 max-w-screen-lg h-full mx-auto flex flex-col items-center justify-center gap-8 md:gap-16 px-4 md:flex-row'>
                <div className='flex flex-col justify-center h-full'>
                    <h2 className='text-4xl md:text-7xl font-bold text-white pt-6'>I'm <span className="bg-gradient-to-t from-cyan-200 to-blue-500 text-transparent bg-clip-text">Muhammad Jareer</span> Front-end Developer</h2>
